...
const Header = () => {
    ...
    return (
        <div className='fixed top-0 left-0 w-full z-50 bg-n-8/90 backdrop-blur-sm
     ...
     max-lg:py-4'>
                ...
                <nav className='hidden fixed top-[5rem] left-0 right-0 buttom-0 bg-n-8
                lg:flex lg:mx-auto lg:static lg:bg-transparent'>
                    <div className='relative z-2 flex flex-col items-center
                  justify-center m-auto lg:flex-row'>
                        {navigation.map((item) => (
                            <a key={item.id} href={item.url}
                                className={`block relative font-code text-2xl uppercase text-n-1
                            transition-color hover:text-color-1
                ...
                transition-color hover:text-n-1 lg:block">
                    New Account
                </a>
